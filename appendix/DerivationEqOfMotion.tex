...
\begin{flalign}
\vec{\dot {\tilde{ q}}} = \dfrac{1}{2} \Big [- \vec{\bar q_{\omega}} \otimes \vec{\tilde{q}} + \vec{\tilde{q}} \otimes \vec{\bar q_{\omega}} + \vec{\tilde q_{\omega}} \otimes \vec{\tilde q_{\omega}} \Big ]
...
= 
\begin{bmatrix}
& - \underline S(\vec{\tilde q}) + \underline{\vec 1} \vec{\tilde q_4} & \vec{\tilde q} \\
& - \vec{\tilde q}^\mathsf{T}& \vec{\tilde q_4}  \\ 
\end{bmatrix} 
\begin{bmatrix}
&   \vec{\bar \omega} \\
& 0 \\ 
...
=
\begin{bmatrix}
& - \underline S(\vec{\bar \omega}) \vec{\tilde q} + \underline{\vec 1} \vec{\tilde q_4} \vec{\bar \omega}  \\
...
=
\begin{bmatrix}
& - \underline S(\vec{\bar \omega}) \vec{\tilde q} +  \vec{\bar \omega} \vec{\tilde q_4}   \\
