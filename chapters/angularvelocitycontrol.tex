...
The higher level controllers give a control demand to the reaction wheels, this torque demand is transformed to angular velocity demand in motor frame. A \textit{PI} controller has been designed to control the angular velocity of the motor as seen in the \figref{fig:blockdi}:
%\begin{figure}[H]
%	\centering
