...
Since the norm of $ \vec{ {\bar{\omega}}} $ is known and equal to the orbital angular velocity ($\approx 0.0011$) comparing this value to $\frac{1}{2}$,becomes small, thus equation \ref{eq:lele} can be simplified to 
\begin{flalign}
	\begin{bmatrix}
		\vec{ \dot {\tilde{q}}(t) } \\
	...
	\label{eq:lelele}
\end{flalign}
Three equal subsystems can be derived from equation \ref{eq:lelele} as
 \begin{flalign}
 	\begin{bmatrix}
 		 \dot { \tilde {q_{i}}} \\
 		 \dot { \tilde { \omega_{i}}}
...
\begin{flalign}
	...
	\label{eq:e33333}
\end{flalign}
and thus replacing equation \ref{eq:seom} expressed for ${\vec{\dot{\tilde{\omega}}}}$ equation \ref{eq:e33333} is written as 
...
Equation \ref{eq:444444} can now be written as 
\begin{flalign}
