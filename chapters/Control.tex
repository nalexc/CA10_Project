...
\Eqref{eq:lele} following \cite{Rafael} can be written as 
%
\begin{flalign}
\begin{bmatrix}
\vec{ \dot {\tilde{q}}(t) } \\
...
\begin{flalign*}
	...
	\label{eq:gainsl223}
\end{flalign*}
which give stability for the all values of $ \vec{ {\bar{\omega}}} $. In the figure \figref{fig:linear demand} it is seen the torque demand from the linear controller for nadir pointing reference.
\begin{figure}[H]
	\centering
