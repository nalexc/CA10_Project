...
Recognizing that the reaction wheels cannot change $\vec{h_{T}}$ total angular momentum, a step can be taken towards detaching the effect of the magnetorquers and the reaction wheels.
