...
\begin{flalign}
	...
	\begin{bmatrix}
		...
		{-\underline{I}_{s}^{-1} \vec{\omega}^\times \underline{I}_{s}\vec{\omega}(t)-\underline{I}_{s}^{-1}\vec{\omega}^\times \vec{h_{rw}}-\underline{I}_{s}^{-1}\vec{N_{rw}}(t)+\underline{I}_{s}^{-1}[\vec{N_{mt}(t)}+\vec{N_{dist}}(t)}]
	\end{bmatrix} 
	\label{eq:seom}
\end{flalign}
where,\\
