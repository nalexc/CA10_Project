...
\nomenclature[AE]{\textbf{ECI}}{Earth Centered Inertial Frame}
\nomenclature[AE]{\textbf{ECEF}}{Earth Centered Earth Fixed Frame}
\nomenclature[AS]{\textbf{SBRF}}{Satellite Body Reference Frame}
\nomenclature[AS]{\textbf{LVHV}}{Local Vertical, Local Horizontal (Reference Frame)}
...
\nomenclature[TV]{\textbf{Vernal Equinox}}{The vernal equinox is the vector pointing towards the Sun's center during the equinox (20th of March in 2018). The $x$ vector also keeps its direction relative to the stars.}
...
\nomenclature[TN]{\textbf{Nadir}}{The axis pointing towards Earth's center of mass}

\subsubsection{Local Vertical, Local Horizontal Frame (LVLH)}
