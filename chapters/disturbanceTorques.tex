...
\begin{table}[H]
	...
	\begin{tabular}{|l|c|l|}
		\hline
		\textit{\textbf{Disturbance}} & \textit{\textbf{\begin{tabular}[c]{@{}c@{}}Torque magnitude at a given\\  moment in the orbit (nNm)\end{tabular}}} & \multicolumn{1}{c|}{\textit{\textbf{\begin{tabular}[c]{@{}c@{}}Torque \\ magnitude (Nm)\end{tabular}}}} \\ \hline
