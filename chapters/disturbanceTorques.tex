...
\nomenclature[A]{COM}{Center of Mass}
%
\begin{flalign}
...
\label{eq:ftf}
\end{flalign}
where $M$ is the Earth magnetic moment and $R$ is the radius from the Earth to the center of the satellite.

\nomenclature[S]{$\vec N_{mr}$}{The torque generated by the magnetic residual }
\nomenclature[S]{$\vec m$}{The magnetic residual}
\nomenclature[S]{$\vec B$}{The magnetic field of the Earth}
\nomenclature[S]{$\vec M$}{The Earth magnetic moment }
\nomenclature[S]{$\vec R$}{The radius from the Earth to the center of the satellite}