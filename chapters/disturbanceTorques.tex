...
%
\begin{flalign}
	\vec N_{gg} &= \dfrac{3\mu}{\vec R_{sc}^3}[\vec{\hat R_{sc}} \times(\vec{I_s} \ \vec{\hat R_{sc}})] 
	\label{eq:ref4}
\end{flalign}
...
%	\begin{tabular}{|l|c|c|}
%		\hline
%		\textit{\textbf{Disturbance}} & \textit{\textbf{Torque order of magnitude (Nm)}} & \textit{\textbf{\begin{tabular}[c]{@{}c@{}}Torque magnitude at a given\\ moment in the orbit (nNm)\end{tabular}}} \\ \hline
%		\textit{Aerodynamic}          & 1.52                                             & $10^{-9}$                                                                                            \\ \hline
%		\textit{Gravitaional}         & 0.86                                             & $10^{-10}$                                                                                           \\ \hline
%		\textit{Radiation}            & 1.25                                             & $10^{-9}$                                                                                        \\ \hline
%		\textit{Magnetic residual}    & 48                                               & $10^{-8}$                                                                                           \\ \hline
%	\end{tabular}
