...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{figures/Observer_simple}
	\caption{}
	\label{fig:obe}
\end{figure}
\subsubsection{Residual generation}
 ...
 \begin{figure}[H]
 	\centering
 	\includegraphics[width=0.9\linewidth]{figures/observerRes}
 	\caption{Luenberger-like Observer structure and residual generation [ref needed]}
 	\label{fig:observer}
 \end{figure}
