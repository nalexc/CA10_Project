...
\subsubsection{Residual generation}
 ...
 \end{equation}
 %
 thus if $\lVert \vec{residual} \rVert \geq threshold$ a fault has been occurred. The structure of Luenberger-like observer can be seen in \figref{fig:observer2} and the generated residual signal in \figref{fig:observerresidual} . 
 %
 %\begin{figure}[H]
 %	\vspace*{1.5cm}
 %	\hspace*{-1cm}\includegraphics[width=0.9\linewidth]{figures/Observer}\hspace*{1cm}
